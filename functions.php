...
function js_custom_init() 
{
  ...
  // Register the Program Highlights
     ...
     $labels = array(
	'name' => _x('MATRAC Program Highlights', 'post type general name'),
    'singular_name' => _x('MATRAC Program Highlights', 'post type singular name'),
    ...
    'parent_item_colon' => '',
    'menu_name' => 'MATRAC Program Highlights'
  );
  $args = array(
	'labels' => $labels,
    'public' => true,
...
/*     $labels = array(
	'name' => _x('MATRAC Resources', 'post type general name'),
  ...
  register_post_type('resources',$args);*/
    ...
    // Register the Homepage Slides
     ...
     $labels = array(
	'name' => _x('MATRAC Homepage Slides', 'post type general name'),
    ...
    'parent_item_colon' => '',
    'menu_name' => 'MATRAC Homepage Slides'
  );
  $args = array(
	'labels' => $labels,
    'public' => true,
...
// add additional image sizes
	...
	register_nav_menu( 'MATRAC', __( 'MATRAC Menu', 'twentytwelve' ) );
...
function ac_my_role_redirect() {
    if(current_user_can('smat_donothing')) {
		...
		return home_url( '/MATRAC/what-we-do' );
	
	} elseif(current_user_can('coalition_donothing')) {
		
		return home_url( '/MATRAC/' );
